...
import { PROJECTS } from "../../david-stones-assets-main/constants";
...
const Projects = () => {
  ...
  return (
    <div>
      {/* Projects Section */}
      <section id="projects" className="container mx-auto py-20" ref={projectRef}>
        <h2 className="text-3xl font-bold text-center mb-10">Projects</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {PROJECTS.map((project) => (
            <div
              key={project.id}
              className="relative group overflow-hidden rounded-lg shadow-lg w-80 h-80"
            >
              {/* Project Image */}
              <img
                src={project.imgSrc}
